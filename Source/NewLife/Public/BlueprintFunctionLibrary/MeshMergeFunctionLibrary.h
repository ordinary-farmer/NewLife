...
struct NEWLIFE_API FSkelMeshMergeSectionMapping_BP
{
	GENERATED_BODY()
...
*/
USTRUCT(BlueprintType)
struct NEWLIFE_API FSkelMeshMergeUVTransform
{
	GENERATED_BODY()
...
*/
USTRUCT(BlueprintType)
struct NEWLIFE_API FSkelMeshMergeUVTransformMapping
{
	GENERATED_BODY()
...
*/
USTRUCT(BlueprintType)
struct NEWLIFE_API FSkeletalMeshMergeParams
{
	GENERATED_BODY()
...
*/
UCLASS()
class NEWLIFE_API UMeshMergeFunctionLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
public:
	/**
